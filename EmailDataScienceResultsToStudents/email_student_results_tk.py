...
class EmailStudentResults:
    def __init__(self, master):
        ...
        self.Test_button = Checkbutton(master, text="Test?",\
                                       variable=self.TestRun,onvalue=1)
        self.Test_button.select()
    ...
    def yagsend_test(self, email_address, subject, contents, attachments, test_dir):
